...
export const metadata: Metadata = {
  ...
  description: "Persona 5 Royal 個人攻略網站。包含人格面具圖鑑、属性抗性查詢、合成規劃工具、技能與特性篩選。",
  keywords: ["P5R, Persona 5 Royal, 人格面具, 女神異聞錄, 攻略, 合成, fusion, persona, 遊戲攻略"],
  authors: [{ name: "P5R Guide" }],
  verification: {
    google: "_uSx3qOAlw7seE1byv-4pHNKpLFoGFaRH-SlEKivS4U",
  },
  openGraph: {
...
export default function RootLayout({
  ...
  return (
    <html lang="zh" suppressHydrationWarning>
      <head>
        <meta name="google-site-verification" content="RoP5o8rdqREvmgwc6MB1aTDaW7B0rNIdMrUd4_l1doQ" />
